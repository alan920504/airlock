...
object ProxyDirectives extends LazyLogging {
  ...
  val metricDuration: Directive0 = extractRequestContext.flatMap {
    requestCtx =>
      ...
      val contentLength = requestCtx.request.entity.contentLengthOption.getOrElse(0L)
      metricsContentLengthCount(requestMethodName, contentLength, "ou bnt")
      mapResponse { response =>
        ...
        metricsContentLengthCount(requestMethodName, contentLength, "in")
        response
      }
  }
